...
enum DswWorkPoolTypes {
  ...
  DSW_WORK_POOL_SET_ACTIVE_NODE = 'DSW_WORK_POOL_SET_ACTIVE_NODE',
...
export const DSW_WORK_POOL_SET_ACTIVE_WORK_POOL = DswWorkPoolTypes.DSW_WORK_POOL_SET_ACTIVE_NODE;
