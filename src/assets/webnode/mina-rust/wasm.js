import { webrtc_transport } from './snippets/libp2p-wasm-ext-a48f6865b9644d09/src/webrtc.js';
...
function __wbg_adapter_38(arg0, arg1, arg2) {
    try {
        wasm._dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h38eed171e9dfcc13(arg0, arg1, addBorrowedObject(arg2));
    } finally {
...
function __wbg_adapter_41(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7285e2050aa4f5b4(arg0, arg1, addHeapObject(arg2));
}

function __wbg_adapter_46(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3137f9e73c5bc6db(arg0, arg1);
}

function __wbg_adapter_49(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2ccfc423a977a38c(arg0, arg1);
}
...
function __wbg_adapter_246(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h27930b235f6379ab(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class Crypto {
    ...
    */
    pub_key_as_protobuf() {
        try {
            ...
            wasm.crypto_pub_key_as_protobuf(retptr, this.ptr);
    ...
    */
    peer_id_as_b58() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.crypto_peer_id_as_b58(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    */
    sign(msg) {
        try {
            ...
            wasm.crypto_sign(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
    ...
    * @returns {string}
    */
    pub_key_as_protobuf_to_peer_id_as_b58(pub_key_as_protobuf) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(pub_key_as_protobuf, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.crypto_pub_key_as_protobuf_to_peer_id_as_b58(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    */
    assert_signature(pub_key_as_protobuf, msg, sig) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(pub_key_as_protobuf, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            ...
            wasm.crypto_assert_signature(retptr, this.ptr, ptr0, len0, ptr1, len1, ptr2, len2);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    pub_key_as_protobuf_to_peer_id(pub_key_as_protobuf, expected_peer_id) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passArray8ToWasm0(pub_key_as_protobuf, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            ...
            const len1 = WASM_VECTOR_LEN;
            wasm.crypto_pub_key_as_protobuf_to_peer_id(retptr, this.ptr, ptr0, len0, ptr1, len1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
...
export class InMemLog {
    ...
    */
    get(key) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.inmemlog_get(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v1;
            if (r0 !== 0) {
    ...
    */
    id() {
        const ret = wasm.inmemlog_id(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    level() {
        const ret = wasm.inmemlog_level(this.ptr);
        return ret >>> 0;
    }
    /**
    * @returns {string}
    */
    as_json() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.inmemlog_as_json(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        } finally {
...
export class JsHandle {
    ...
    static __wrap(ptr) {
        const obj = Object.create(JsHandle.prototype);
        obj.ptr = ptr;
    ...
    * @returns {Promise<any>}
    */
    logs_range(cursor, limit) {
        const ret = wasm.jshandle_logs_range(this.ptr, !isLikeNone(cursor), isLikeNone(cursor) ? 0 : cursor, !isLikeNone(limit), isLikeNone(limit) ? 0 : limit);
        return takeObject(ret);
    }
    /**
    ...
    */
    manual_connector() {
        const ret = wasm.jshandle_manual_connector(this.ptr);
        return ManualConnector.__wrap(ret);
    }
    /**
    * @param {string} id
    */
    is_peer_id_valid(id) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.jshandle_is_peer_id_valid(retptr, this.ptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            if (r1) {
                throw takeObject(r0);
    ...
    */
    global_state_get() {
        const ret = wasm.jshandle_global_state_get(this.ptr);
        return takeObject(ret);
    }
    /**
    * @param {string} addr
    ...
    */
    peer_connect(addr) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.jshandle_peer_connect(this.ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {string} topic
    ...
    */
    pubsub_publish(topic, msg) {
        const ptr0 = passStringToWasm0(topic, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.jshandle_pubsub_publish(this.ptr, ptr0, len0, addHeapObject(msg));
        return takeObject(ret);
    }
    /**
    * @returns {any}
    */
    generate_account_keys() {
        const ret = wasm.jshandle_generate_account_keys(this.ptr);
        return takeObject(ret);
    }
    /**
    * @param {any} data
    * @returns {Promise<any>}
    */
    payment_sign_and_inject(data) {
        const ret = wasm.jshandle_payment_sign_and_inject(this.ptr, addHeapObject(data));
        return takeObject(ret);
    }
    /**
    ...
    */
    watched_accounts() {
        const ret = wasm.jshandle_watched_accounts(this.ptr);
        return WatchedAccounts.__wrap(ret);
    }
}
/**
*/
export class ManualConnector {
    ...
    static __wrap(ptr) {
        const obj = Object.create(ManualConnector.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_manualconnector_free(ptr);
    }
    /**
    ...
    */
    dial(peer_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.manualconnector_dial(this.ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @returns {any}
    */
    listen() {
        const ret = wasm.manualconnector_listen(this.ptr);
        return takeObject(ret);
    }
}
/**
...
export class WasmConfig {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmconfig_free(ptr);
    }
    /**
    */
    constructor() {
    ...
    */
    set_block_verifier_index(value) {
        wasm.wasmconfig_set_block_verifier_index(this.ptr, isLikeNone(value) ? 0 : addHeapObject(value));
    }
    /**
    * @param {Promise<any> | undefined} value
    */
    set_block_verifier_srs(value) {
        wasm.wasmconfig_set_block_verifier_srs(this.ptr, isLikeNone(value) ? 0 : addHeapObject(value));
    }
}
/**
*/
export class WatchedAccounts {
    ...
    static __wrap(ptr) {
        const obj = Object.create(WatchedAccounts.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_watchedaccounts_free(ptr);
    }
    /**
    ...
    */
    add(pub_key) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.watchedaccounts_add(this.ptr, ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {string} pub_key
    ...
    */
    get(pub_key) {
        const ptr0 = passStringToWasm0(pub_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.watchedaccounts_get(this.ptr, ptr0, len0);
        return takeObject(ret);
    }
}
...
function getImports() {
    ...
    imports.wbg.__wbg_jshandle_new = function(arg0) {
        const ret = JsHandle.__wrap(arg0);
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_static_accessor_HARDWARE_CONCURRENCY_a18783715e012b30 = function() {
    ...
    imports.wbg.__wbg_dial_97f1b574b7121d7d = function() { return handleError(function (arg0, arg1, arg2, arg3) {
        const ret = getObject(arg0).dial(getStringFromWasm0(arg1, arg2), arg3 !== 0);
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbg_listenon_0054b0faba4d4f98 = function() { return handleError(function (arg0, arg1, arg2) {
        const ret = getObject(arg0).listen_on(getStringFromWasm0(arg1, arg2));
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbg_newaddrs_e2720a57ff4fbce8 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_newconnections_9553eb2662c01618 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_observedaddr_015739fd4bc4b5af = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_connection_78b20fcb5c483226 = function(arg0) {
        const ret = getObject(arg0).connection;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_close_584b44cb67fe8370 = function(arg0) {
        getObject(arg0).close();
    };
    imports.wbg.__wbg_shutdown_6dbc289d8e36ab3f = function() { return handleError(function (arg0) {
        getObject(arg0).shutdown();
    }, arguments) };
    imports.wbg.__wbg_localaddr_d62be8d0ab684ccf = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_expiredaddrs_2c2f50e12ee1135e = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_read_69587c7c23bcbacc = function(arg0) {
        const ret = getObject(arg0).read;
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_remotepubkey_43e5a787b9758edd = function(arg0) {
        const ret = getObject(arg0).remote_pub_key();
    ...
    imports.wbg.__wbg_write_1544c1bc1f3744b3 = function() { return handleError(function (arg0, arg1, arg2) {
        const ret = getObject(arg0).write(getArrayU8FromWasm0(arg1, arg2));
        return addHeapObject(ret);
    }, arguments) };
    imports.wbg.__wbg_manualconnector_2e341a8cc8d38dec = function(arg0) {
        const ret = getObject(arg0).manual_connector();
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_listen_0f7e02dfd8d14193 = function(arg0) {
        const ret = getObject(arg0).listen();
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_dial_7fe0a10c2ca7b353 = function(arg0, arg1, arg2) {
        try {
    ...
    imports.wbg.__wbg_webrtctransport_83a9ec8524ead171 = function(arg0) {
        const ret = webrtc_transport(Crypto.__wrap(arg0));
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbg_trace_b57a30721e360d5d = function(arg0) {
    ...
    imports.wbg.__wbindgen_closure_wrapper3875 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 758, __wbg_adapter_38);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper4717 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 997, __wbg_adapter_41);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper5447 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 1199, __wbg_adapter_46);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper7910 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 1958, __wbg_adapter_49);
        return addHeapObject(ret);
    };
