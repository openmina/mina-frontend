...
export const environment: Readonly<MinaEnv> = {
  ...
  // configs: [
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node01',
  //     name: 'node01',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node02',
  //     name: 'node02',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node03',
  //     name: 'node03',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node04',
  //     name: 'node04',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node05',
  //     name: 'node05',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node06',
  //     name: 'node06',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node07',
  //     name: 'node07',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node08',
  //     name: 'node08',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
  //     backend: 'http://1.k8.openmina.com:31308/node09',
  //     name: 'node09',
  //     features: ['dashboard', 'network', 'benchmarks', 'explorer', 'tracing'],
  //   },
  //   {
